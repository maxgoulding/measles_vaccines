...
function y = proportionrealisticBSVIRcost (vage)
...
%solverealisticBSVIRpop same as solverealisticBSVIRpop apart from returns
%the population matrix instead of group history.
postmassvaccpop = solverealisticBSVIRpop(u0,massvaccprop,massvaccage,intromassvaccyear, (intromassvaccyear + massvaccperiod));
while (c<=l)
    p = prop(c);
    temp = solvenewinfectiousandvaccrealisticsingleBSVIR(postmassvaccpop,p,vage,0,50);
