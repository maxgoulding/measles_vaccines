%Solves the realistic (single vaccination) BSVIR model using the fourth
...
%mothers that lose immunity between time steps.
function y = solvenewinfectiousandvaccrealisticsingleBSVIR(population,p,vage,vyear,n)
c = 1;
h = 1/365;
t = [0:h:n];
l = length(t);
